const calculatePlotVariables = (userInput, defaultXAxisLength) => {
  ...
  if (endYear - startYear + 1 > 0) {
    periodUntilRetirement = [...Array(endYear - startYear + 1)].map((_, i) => i + startYear)
  }
  if (endYear - startYear + 1 <= 0) {
    periodUntilRetirement = [...Array(defaultXAxisLength)].map((_, i) => i + startYear)
  }
...
export default calculatePlotVariables